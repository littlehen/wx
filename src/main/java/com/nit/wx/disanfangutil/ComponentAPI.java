package com.nit.wx.disanfangutil;
...
import com.nit.wx.api.API;
import com.nit.wx.bean.BaseResult;
import com.nit.wx.bean.component.ApiGetAuthorizerInfoResult;
import com.nit.wx.bean.component.ApiQueryAuthResult;
import com.nit.wx.bean.component.AuthorizerAccessToken;
import com.nit.wx.bean.component.AuthorizerOption;
import com.nit.wx.bean.component.ComponentAccessToken;
import com.nit.wx.bean.component.PreAuthCode;
import com.nit.wx.client.LocalHttpClient;
...
public class ComponentAPI extends BaseAPI{
	...
	/**
	 * 
	 * @Description 获取公众号第三方平台access_token
	 * @author 吴佶津
	 * @date 2018年4月16日
	...
	/**
	 * 
	 * @Description 第三方平台对其所有API调用次数清零
	 * @author 吴佶津
	 * @date 2018年4月16日
	 * @since 2.8.2
